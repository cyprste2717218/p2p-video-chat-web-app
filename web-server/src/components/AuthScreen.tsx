      ...
      <div className="w-full max-w-md space-y-6">
        ...
        <Card className="bg-zinc-900 border-zinc-800">
          <CardHeader className="pb-2">
            ...
            <CardDescription className="text-zinc-400">Sign in or create a new account</CardDescription>
          </CardHeader>
          <CardContent>
            <Tabs defaultValue="login">
              <TabsList className="w-full bg-zinc-800 mb-4">
                <TabsTrigger value="login" className="flex-1 data-[state=active]:bg-zinc-700 data-[state=active]:text-zinc-100 text-zinc-400">
                  Login
                </TabsTrigger>
                <TabsTrigger value="register" className="flex-1 data-[state=active]:bg-zinc-700 data-[state=active]:text-zinc-100 text-zinc-400">
                  Register
                </TabsTrigger>
              </TabsList>
