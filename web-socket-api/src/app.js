...
const ALLOWED_DEV_ORIGINS=process.env.LOCAL==='true'? ['http://localhost:4321']:[`https://${process.env.NGROK_HOST}`];
const ALLOWED_PROD_ORIGINS=[``]; // To-do: to be assigned based on deployment through pullumi

const ALLOWED_ORIGINS=process.env.NODE_ENV==='dev'? ALLOWED_DEV_ORIGINS:ALLOWED_PROD_ORIGINS;
