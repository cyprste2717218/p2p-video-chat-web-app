...
const CallModel = {
	...
	partcipants: { type: DataTypes.JSON, allowNull: true, references: { model: 'users', key: 'email' } },
	pendingParticipants: { type: DataTypes.JSON, allowNull: true, references: { model: 'users', key: 'email' } },
